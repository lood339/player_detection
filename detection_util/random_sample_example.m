function [positive, negative] = random_sample_example(image, bounding_box, patch_size)
% [positive, negative] = random_sample_example(bounding_box, image, patch_size)
...
negative = zeros(patch_h, patch_w, c, N);

% crop positive area
for i = [1:N]
    patch = imcrop(im, bbox(i, [1:4]));
